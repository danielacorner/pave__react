      ...
      <svg width="0" height="0">
        <defs>
          <clipPath id="moneyClip">
            <path style={{ transform: `translate(${ICON_WIDTH*0}px, ${ICON_DY}px) scale(${ICON_SCALE})` }} d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" />
            <path style={{ transform: `translate(${ICON_WIDTH*0}px, ${ICON_DY}px) scale(${ICON_SCALE})` }} d="M12.31 11.14c-1.77-.45-2.34-.94-2.34-1.67 0-.84.79-1.43 2.1-1.43 1.38 0 1.9.66 1.94 1.64h1.71c-.05-1.34-.87-2.57-2.49-2.97V5H10.9v1.69c-1.51.32-2.72 1.3-2.72 2.81 0 1.79 1.49 2.69 3.66 3.21 1.95.46 2.34 1.15 2.34 1.87 0 .53-.39 1.39-2.1 1.39-1.6 0-2.23-.72-2.32-1.64H8.04c.1 1.7 1.36 2.66 2.86 2.97V19h2.34v-1.67c1.52-.29 2.72-1.16 2.73-2.77-.01-2.2-1.9-2.96-3.66-3.42z" />
            <path
              style={{ transform: `translate(${ICON_WIDTH*1}px, ${ICON_DY}px) scale(${ICON_SCALE})` }}
            ...
            />
            <path
              style={{ transform: `translate(${ICON_WIDTH * 2}px, ${ICON_DY}px) scale(${ICON_SCALE})` }}
              d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"
            />
            <path
              style={{ transform: `translate(${ICON_WIDTH * 2}px, ${ICON_DY}px) scale(${ICON_SCALE})` }}
            ...
            />
            <path
              style={{ transform: `translate(${ICON_WIDTH * 3}px, ${ICON_DY}px) scale(${ICON_SCALE})` }}
              d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"
            />
            <path
              style={{ transform: `translate(${ICON_WIDTH * 3}px, ${ICON_DY}px) scale(${ICON_SCALE})` }}
            ...
            />
            <path
              style={{ transform: `translate(${ICON_WIDTH * 4}px, ${ICON_DY}px) scale(${ICON_SCALE})` }}
              d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"
            />
            <path
              style={{ transform: `translate(${ICON_WIDTH * 4}px, ${ICON_DY}px) scale(${ICON_SCALE})` }}
          ...
          <clipPath id="riskClip">
            <path style={{ transform: `translate(${ICON_WIDTH*0}px, ${ICON_DY}px) scale(${ICON_SCALE})` }}
          ...
          <clipPath id="studyClip">
            <path style={{ transform: `translate(${ICON_WIDTH*0}px, ${ICON_DY}px) scale(${ICON_SCALE})` }} d="M5 13.18v2.81c0 .73.4 1.41 1.04 1.76l5 2.73c.6.33 1.32.33 1.92 0l5-2.73c.64-.35 1.04-1.03 1.04-1.76v-2.81l-6.04 3.3c-.6.33-1.32.33-1.92 0L5 13.18zm6.04-9.66l-8.43 4.6c-.69.38-.69 1.38 0 1.76l8.43 4.6c.6.33 1.32.33 1.92 0L21 10.09V16c0 .55.45 1 1 1s1-.45 1-1V9.59c0-.37-.2-.7-.52-.88l-9.52-5.19a2.04 2.04 0 0 0-1.92 0z" />
            <path
              style={{ transform: `translate(${ICON_WIDTH*1}px, ${ICON_DY}px) scale(${ICON_SCALE})` }}
